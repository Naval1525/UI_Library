...
const DeveloperLanding = () => {
  ...
  const allComponents = Object.entries(categories).reduce(
    (acc, [category, items]) => {
  ...
  return (
    <div className="h-full bg-black text-white">
            ...
            <nav className="hidden md:flex ml-10 mr-auto space-x-10 lg:ml-20 lg:space-x-12">
              {[
                ...
                <a
                  ...
                  className="text-lg font-normal text-gray-300 hover:text-rose-400 transition-all duration-200"
                >
                  {item}
                </a>
              ))}
      ...
      {showDropdown && !isDark && (
        <div className="absolute right-0 top-full mt-2 w-48 bg-black border rounded-lg shadow-lg p-2">
          <p className="text-sm text-white">Light mode is for noobs 🤓</p>
          <button
              ...
              <div className="flex flex-col pt-8 pb-4 space-y-6">
                {[
                  ...
                  <a
                    key={item}
                    href={`/${item.toLowerCase()}`}
                    className="text-base font-normal text-gray-300 hover:text-rose-400 transition-all duration-200"
                  >
                    {item}
                  </a>
                ))}
                ...
                {/* <div className="relative inline-flex items-center justify-center group">
                  ...
                  <a
                    href="/trial"
                    className="relative inline-flex items-center justify-center w-full px-6 py-2 text-base font-normal text-black bg-white border border-transparent rounded-full"
                  >
                    Start free trial
                  </a>
                </div> */}
          ...
          <div className="grid items-center h-full grid-cols-1 gap-y-12 lg:grid-cols-2 gap-x-16">
            <div className="-mt-32">
              <h1 className="text-4xl font-semi-bold  sm:text-5xl lg:text-6xl xl:text-7xl">
                Helping{" "}
                <span className=" font-extrabold text-fuchsia-600">Devs</span>{" "}
                with Components
              </h1>
